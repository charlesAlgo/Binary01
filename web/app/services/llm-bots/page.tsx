...
const FEATURES = [
  {
    ...
    title: "RAG Pipelines",
    description: "Retrieval-Augmented Generation connects the LLM to your documents, databases, and knowledge base so answers are grounded in your actual data — not hallucinations.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "I ingest your PDFs, docs, Notion pages, or databases into a ChromaDB or Pinecone vector store — keeping the bot accurate and up-to-date.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "Context-aware dialogue that remembers what was said earlier in the conversation — enabling natural, helpful exchanges rather than one-shot Q&A.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "A conversational funnel that identifies project type, budget, and urgency — then saves qualified leads to Supabase and fires a Slack alert.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "Bot actions wired to HubSpot, Salesforce, or any CRM via webhook or API — so every qualified conversation automatically updates your records.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "System-prompt hardening, topic restrictions, and prompt-injection defence so the bot stays on-brand and never leaks sensitive information.",
  },
];
...
const STEPS = [
  {
    ...
    description: "We define exactly what the bot should do, what it should never do, and what a successful conversation looks like. This shapes everything that follows.",
  },
  {
    title: "Knowledge Base Prep",
    description: "Your source documents are cleaned, chunked, embedded, and loaded into a vector store. I audit coverage so the bot can actually answer the questions it will receive.",
  },
  {
    title: "Bot Build & Testing",
    description: "System prompt engineering, RAG pipeline wiring, and iterative red-teaming to catch hallucinations, off-topic responses, and edge cases before launch.",
  },
  {
    title: "Deployment & Monitoring",
    description: "The bot is embedded in your site or app, wired to your CRM, and connected to a Supabase log so you can review every conversation and improve over time.",
  },
];
...
const TECH = ["LangChain", "OpenAI API", "Anthropic API", "ChromaDB", "Pinecone", "Next.js", "Supabase", "Vercel AI SDK"];

const PLANS = [
  {
    name: "Starter",
    price: "$600 – $1,200",
    description: "A focused AI assistant for one specific use case.",
    features: [
  ...
  },
  {
    name: "Growth",
    price: "$2,000 – $4,000",
    description: "A full-featured AI assistant with CRM and lead qualification.",
    features: [
  ...
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "Organisation-wide AI assistant with ongoing content updates.",
    features: [
...
export default function LLMBotsPage() {
  return (
    <>
      {/* ── 1. Hero ── */}
      <section
      ...
      >
        ...
        <div className="section-wrapper" style={{ position: "relative" }}>
          ...
          <nav aria-label="Breadcrumb" style={{ marginBottom: "1.75rem", display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: "0.8125rem" }}>›</span>
            <span style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.75)", fontFamily: "var(--font-body)" }}>LLM Bots</span>
          </nav>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem, 5vw, 4rem)", alignItems: "center" }}>
            ...
            <div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "7px", padding: "5px 14px", borderRadius: "999px", border: "1px solid rgba(62,189,122,0.35)", backgroundColor: "rgba(62,189,122,0.08)", marginBottom: "1.5rem" }}>
                ...
                <span style={{ fontSize: "0.8125rem", fontWeight: 500, color: "var(--color-accent)", fontFamily: "var(--font-body)" }}>LLM Bots</span>
              </div>
        ...
        <div className="section-wrapper">
          <div style={{ marginBottom: "3rem" }}>
            <SectionHeader
              ...
              title="Everything needed for a production-grade AI assistant"
              description="From knowledge base ingestion to live deployment — I handle the full stack so you get a bot that actually works for your business."
              align="left"
            />
          </div>
      ...
      <section style={{ backgroundColor: "var(--color-bg-primary)", paddingBlock: "clamp(4rem, 8vw, 6rem)" }}>
        <div className="section-wrapper">
          <div style={{ marginBottom: "2.5rem" }}>
            <SectionHeader
              label="Tech stack"
              title="Tools I use for LLM Bots"
              description="Best-in-class LLM infrastructure — from embedding and retrieval to streaming chat and production deployment."
              align="left"
            />
          </div>
        ...
        <div className="section-wrapper">
          <div style={{ marginBottom: "3rem", textAlign: "center" }}>
            <SectionHeader
              ...
              description="Priced per project — not per API call. You own the code and the data."
              align="center"
            />
          </div>
