...
const FEATURES = [
  {
    ...
    description: "Interactive Power BI and Tableau dashboards tailored to your KPIs — built for both executives and analysts.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "Scheduled Python or dbt pipelines that refresh your reports automatically — no more manual exports on Monday mornings.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "Pandas-powered pipelines that standardise, deduplicate, and validate your raw data so your numbers are actually trustworthy.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    title: "KPI Tracking",
    description: "Define the metrics that matter, then build live scorecards that keep every team aligned on the same numbers.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "Slow queries blocking your analysts? I audit, rewrite, and index your SQL so dashboards load in seconds, not minutes.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    ...
    description: "Polished PDF reports, Excel workbooks, and slide-ready charts delivered in the format your leadership team actually opens.",
  },
];
...
const STEPS = [
  {
    title: "Data Audit",
    description: "I review your data sources, formats, and quality issues. You get a plain-English summary of what's there, what's missing, and what's fixable.",
  },
  {
    title: "Schema & Pipeline Design",
    description: "We agree on a clean schema and a lightweight ETL pipeline that fits your existing stack — no unnecessary infrastructure.",
  },
  {
    title: "Dashboard Build",
    description: "Iterative build in weekly check-ins. You review live previews and request changes before anything is finalised.",
  },
  {
    title: "Training & Handover",
    description: "A 60-minute walkthrough call, written documentation, and 30 days of free support so your team can use everything independently.",
  },
];
...
const TECH = ["Python", "Pandas", "SQL", "Power BI", "Tableau", "dbt", "Supabase", "Excel"];

const PLANS = [
  {
    name: "Starter",
    price: "$300 – $500",
    description: "A single dashboard or report for a small dataset.",
    features: [
  ...
  },
  {
    name: "Growth",
    price: "$800 – $1,500",
    description: "A full analytics setup for a growing team.",
    features: [
      "Up to 8 data sources",
      "3 dashboards + KPI scorecard",
      "Automated refresh pipeline",
      "SQL optimisation audit",
      "3 revision rounds + handover call",
    ],
    cta: "Get Started",
    highlight: true,
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "End-to-end data infrastructure for complex needs.",
    features: [
      ...
      >
        ...
        <div className="section-wrapper" style={{ position: "relative" }}>
          ...
          <nav aria-label="Breadcrumb" style={{ marginBottom: "1.75rem", display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.25)", fontSize: "0.8125rem" }}>›</span>
            <span style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.75)", fontFamily: "var(--font-body)" }}>Data Analysis</span>
          </nav>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem, 5vw, 4rem)", alignItems: "center" }}>
            ...
            <div>
              ...
              <div style={{ display: "inline-flex", alignItems: "center", gap: "7px", padding: "5px 14px", borderRadius: "999px", border: "1px solid rgba(62,189,122,0.35)", backgroundColor: "rgba(62,189,122,0.08)", marginBottom: "1.5rem" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 20V10M18 20V4M6 20v-4"/></svg>
                <span style={{ fontSize: "0.8125rem", fontWeight: 500, color: "var(--color-accent)", fontFamily: "var(--font-body)" }}>Data Analysis</span>
              </div>

              <h1 style={{ color: "#fff", marginBottom: "1.25rem", lineHeight: 1.08, maxWidth: "15ch" }}>
                Turn Your Raw Data Into Clear Business Decisions
              </h1>
              ...
              <p style={{ color: "rgba(255,255,255,0.62)", fontSize: "1.0625rem", maxWidth: "44ch", lineHeight: 1.75, fontFamily: "var(--font-body)", marginBottom: "2.25rem" }}>
                From messy spreadsheets to polished executive dashboards — I audit your data, build clean pipelines, and deliver reports your stakeholders actually read.
              </p>
            ...
            <div style={{ borderRadius: "16px", border: "1px solid rgba(255,255,255,0.08)", backgroundColor: "rgba(255,255,255,0.04)", backdropFilter: "blur(12px)", padding: "1.75rem" }}>
              ...
              {[
                ...
                "Automated pipelines — no manual exports",
                "Clean, validated data you can trust",
                "Stakeholder-ready exports in any format",
              ].map((item) => (
        ...
        <div className="section-wrapper">
          <div style={{ marginBottom: "3rem" }}>
            <SectionHeader
              ...
              title="Everything you need to go from raw data to real insight"
              description="Each engagement covers the full journey — from messy source files to polished, reliable outputs your team trusts."
              align="left"
            />
          </div>
      ...
      <section style={{ backgroundColor: "var(--color-bg-primary)", paddingBlock: "clamp(4rem, 8vw, 6rem)" }}>
        <div className="section-wrapper">
          <div style={{ marginBottom: "2.5rem" }}>
            <SectionHeader
              label="Tech stack"
              title="Tools I use for Data Analysis"
              description="Industry-standard tools chosen for reliability, performance, and how well they fit your existing workflow."
              align="left"
            />
          </div>
        ...
        <div className="section-wrapper">
          <div style={{ marginBottom: "3rem", textAlign: "center" }}>
            <SectionHeader
              ...
              description="No hourly billing surprises. Pick the plan that fits your scope, or reach out for a custom quote."
              align="center"
            />
          </div>
      ...
      <section style={{ backgroundColor: "var(--color-hero)", paddingBlock: "clamp(4rem, 8vw, 5.5rem)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="section-wrapper" style={{ position: "relative", textAlign: "center" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.62)", fontSize: "1.0625rem", fontFamily: "var(--font-body)", maxWidth: "44ch", marginInline: "auto", marginBottom: "2.25rem", lineHeight: 1.7 }}>
            Tell me about your data and I&apos;ll send a clear scope and quote within 24 hours.
          </p>
